...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-edit mr-2"></i>Edit Medicine — {{ $medicine->name }}
        </h3>
    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="supplier_id" class="form-control" required>
                            @foreach($suppliers as $sup)
                                <option value="{{ $sup->id }}"
                                    {{ old('supplier_id', $medicine->supplier_id) == $sup->id ? 'selected' : '' }}>
                                    {{ $sup->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="stock_quantity" class="form-control"
                               value="{{ old('stock_quantity', $medicine->stock_quantity) }}" required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="expiry_date" class="form-control"
                               value="{{ old('expiry_date', $medicine->expiry_date) }}" required>
                    </div>
                </div>
